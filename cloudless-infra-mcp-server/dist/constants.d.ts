...
export declare const SSM_PREFIX: any;
...
export declare const CLOUDFRONT_DISTRIBUTION_ID = "ELGQBR8109MTM";
export declare const CLOUDFRONT_ORIGIN_GROUP_ID = "primary-with-ha";
export declare const TAILSCALE_FUNNEL_HOST = "omv.tail8eb71.ts.net";
export declare const K3S_TRAEFIK_VIP = "192.168.1.200";
...
export declare const CLOUDFLARE_API_TOKEN: any;
export declare const CLOUDFLARE_ACCOUNT_ID: any;
export declare const CLOUDFLARE_ZONE_ID: any;
